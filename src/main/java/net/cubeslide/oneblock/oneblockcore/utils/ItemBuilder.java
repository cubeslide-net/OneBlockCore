...
public class ItemBuilder {
    ...
    public static final ItemStack CYAN_GLASS = new ItemBuilder( Material.CYAN_STAINED_GLASS_PANE ).name( "§e" ).build();
    public static final ItemStack PREVIOUS_PAGE = new ItemBuilder( Material.PAPER ).name( "§cPage back" ).build();
    public static final ItemStack NEXT_PAGE = new ItemBuilder( Material.PAPER ).name( "§cNext page" ).build();
